...
static const char *const pthread_maybe[] =
{
  ...
  "pthread_condattr_setpshared", "mythread_create" ,"pthread_create", "mythread_detach" , "pthread_detach", "mythread_setsched","pthread_dispmssg",
  "pthread_equal", "mythread_end" ,"pthread_exit", "pthread_getspecific", "mythread_join" ,"pthread_join",
  ...
  "pthread_mutex_init", "pthread_mutex_lock","mymutex_lock", "pthread_mutex_setprioceiling",
  "pthread_mutex_trylock","mymutex_trylock", "pthread_mutex_unlock", "mymutex_unlock", "pthread_mutexattr_destroy",
