...
Nodo searchNodo(int data);     // busca un nodo respecto a su dato.
int searchNodoPosition(int data);  //se busca una posicion con respecto a su elemento 
int searchNodoPositionHigh(int data);  //se busca una posicion con respecto al elemento
