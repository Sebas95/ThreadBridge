...
extern int pthread_mutex_init (pthread_mutex_t *__mutex,
     ...
     /* Initialize a mutex.  */
extern int mymutex_init (pthread_mutex_t *__mutex,
             const pthread_mutexattr_t *__mutexattr)
     __THROW __nonnull ((1));
...
extern int mymutex_destroy (pthread_mutex_t *__mutex)
     __THROW __nonnull ((1));
...
/* Try locking a mutex.  */
extern int mymutex_trylock (pthread_mutex_t *__mutex)
     __THROWNL __nonnull ((1));
...
extern int mymutex_unlock (pthread_mutex_t *__mutex)
     __THROWNL __nonnull ((1));
